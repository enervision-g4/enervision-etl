...
Ce module double celui du collecteur. Les deux services se deploient separement, et une
dependance croisee entre leurs paquets ferait entrer le client HTTP et le producer Kafka
dans l'image du consumer, qui n'en a aucun usage.
"""
