...
processus sur SIGTERM sans executer les blocs finally : un message pourrait etre ecrit
en base sans que son offset soit acquitte, ou l'inverse selon l'instant de la coupure.

Le signal ne fait donc que lever un drapeau. La boucle le consulte avant de lire le
message suivant, termine celui qui est en cours jusqu'a son acquittement, puis rend la
main normalement.
"""
